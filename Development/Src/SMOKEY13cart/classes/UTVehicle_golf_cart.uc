 ...
 */
class UTVehicle_golf_cart extends UTVehicle
    abstract;
...
defaultproperties
{
    ...
    WheelSuspensionDamping=1.0
        ...
        MaxSteerAngleCurve=(Points=((InVal=0,OutVal=45),(InVal=600.0,OutVal=15.0),(InVal=1100.0,OutVal=10.0),(InVal=1300.0,OutVal=6.0),(InVal=2000.0,OutVal=3.0)))
        SteerSpeed=110

        LSDFactor=0.0
        TorqueVSpeedCurve=(Points=((InVal=-600.0,OutVal=0.0),(InVal=-300.0,OutVal=40.0),(InVal=0.0,OutVal=55.0),(InVal=450.0,OutVal=60.0),(InVal=6050.0,OutVal=10.0),(InVal=9150.0,OutVal=0.0)))
        ...
        EngineBrakeFactor=0.010
        ThrottleSpeed=0.2
        WheelInertia=0.2
        NumWheelsForFullSteering=4
        SteeringReductionFactor=6.0
        ...
        WheelLatAsymptoteSlip=8.4     // 80 degrees
    ...
    //if you delete the "//" on "latslipfactor=2.0" the raer wheels have more sideways slip.
    //suspension controlled by "UTVehiclegolf_cartwheel.uc"
    Begin Object Class=UTVehiclegolf_cartWheel Name=RRWheel
    BoneName="cart_RR_wheel"
        BoneOffset=(X=0.0,Y=0.0,Z=0.0)
        //LatSlipFactor=2.0
        WheelRadius=12.55
        SkelControlName="cart_RR_wheel_control"
    End Object
    Wheels(0)=RRWheel

    Begin Object Class=UTVehiclegolf_cartWheel Name=LRWheel
    BoneName="cart_LR_wheel"
        BoneOffset=(X=0.0,Y=-0.0,Z=0.0)
        //LatSlipFactor=2.0
        WheelRadius=12.55
        SkelControlName="cart_LR_wheel_Control"
    End Object
    Wheels(1)=LRWheel

    //if you delete the "//" on "bPoweredWheel=false" the car wil be rear wheel drive instead if four.
    Begin Object Class=UTVehiclegolf_cartWheel Name=RFWheel
    BoneName="cart_RF_wheel"
        BoneOffset=(X=0.0,Y=0.0,Z=0.0)
        WheelRadius=12.55
        //bPoweredWheel=false
        SteerFactor=1.0
        ...
        SkelControlName="cart_RF_wheel_Control"
    End Object
    Wheels(2)=RFWheel

    Begin Object Class=UTVehiclegolf_cartWheel Name=LFWheel
    BoneName="cart_LF_wheel"
        BoneOffset=(X=0.0,Y=-0.0,Z=0.0)
        WheelRadius=12.55
        //bPoweredWheel=false
        SteerFactor=1.0
