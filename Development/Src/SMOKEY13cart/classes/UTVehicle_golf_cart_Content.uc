...
class UTVehicle_golf_cart_Content extends UTVehicle_golf_cart;
...
defaultproperties
{
    ...
    AnimTreeTemplate=AnimTree'VH_SMOKEY13_golf_cart.Anims.AT_VH_SMOKEY13_golf_cart'
    PhysicsAsset=PhysicsAsset'VH_SMOKEY13_golf_cart.Mesh.golf_cart_Physics'
    MorphSets[0]=MorphTargetSet'VH_SMOKEY13_golf_cart.Mesh.VH_golf_cart_MorphTargets'
        AnimSets.Add(AnimSet'VH_SMOKEY13_golf_cart.Anims.golf_cart_Anims'')
    ...
    Seats(0)={(    GunClass=class'UTVWeap_golf_cart_Turret',
    ...
    //My Animations
    VehicleAnims(0)=(AnimTag=EngineStart,AnimSeqs=(Car_Start),AnimRate=0.5,bAnimLoopLastSeq=false,AnimPlayerName=TestPlayer)
    VehicleAnims(1)=(AnimTag=Idle,AnimSeqs=(Car_Running),AnimRate=1.0,bAnimLoopLastSeq=true,AnimPlayerName=TestPlayer)
    VehicleAnims(2)=(AnimTag=EngineStop,AnimSeqs=(Car_Stop),AnimRate=0.5,bAnimLoopLastSeq=false,AnimPlayerName=TestPlayer)
    ...
    DamageMorphTargets(0)=(InfluenceBone=front_damage,MorphNodeName=MorphNodeW_Front,Health=30,DamagePropNames=(Damage2))
    DamageMorphTargets(1)=(InfluenceBone=rear_damage,MorphNodeName=MorphNodeW_Rear,Health=30,DamagePropNames=(Damage2))
    ...
    SpawnMaterialLists[0]=(Materials=(MaterialInterface'VH_SMOKEY13_golf_cart.Materials.M_VH_golf_cart_A_INST_spawn'))
    SpawnMaterialLists[1]=(Materials=(MaterialInterface'VH_SMOKEY13_golf_cart.Materials.M_VH_golf_cart_B_INST_Spawn'))

    TeamMaterials[0]=MaterialInstanceConstant'VH_SMOKEY13_golf_cart.Materials.M_VH_golf_cart_A_INST'
    TeamMaterials[1]=MaterialInstanceConstant'VH_SMOKEY13_golf_cart.Materials.M_VH_golf_cart_B_INST'

    SuspensionShiftSound=SoundCue'A_Vehicle_Generic.Vehicle.VehicleCompressD_Cue'

    DrivingPhysicalMaterial=PhysicalMaterial'VH_SMOKEY13_golf_cart.materials.physMat_golf_cartdriving'
    DefaultPhysicalMaterial=PhysicalMaterial'VH_SMOKEY13_golf_cart.materials.physMat_golf_cart'

    BurnOutMaterial[0]=MaterialInterface'VH_SMOKEY13_golf_cart.Materials.M_VH_golf_cart_A_Burnout_INST'
    BurnOutMaterial[1]=MaterialInterface'VH_SMOKEY13_golf_cart.Materials.M_VH_golf_cart_B_Burnout_INST'
