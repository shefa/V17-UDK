...
CylinderPosition = GetALocalPlayerController().Pawn.Location; Setlocation(CylinderPosition);
...
lastSpawnPosition = CylinderPosition;
}
}
}
...
//if(spawnedGrass!=none ) WorldInfo.Game.Broadcast(self,    "fak its not precomputed  "@spawnedGrass.StaticMeshComponent.bUsePrecomputedShadows);
...
DefaultProperties
{
physMatMask = PhysicalMaterial'MeleeWeaponContent.Archetypes.PM_Grass'
MaxGrassCount = 1200
...
IniCil=1
foliage[0]=RuntimeGrass'Archetypes.RuntimeGrass.grass1'
foliage[1]=RuntimeGrass'Archetypes.RuntimeGrass.fern'
foliage[2]=RuntimeGrass'Archetypes.RuntimeGrass.flower'
foliage[3]=RuntimeGrass'Archetypes.RuntimeGrass.tropical_plant_1'
foliage[4]=RuntimeGrass'Archetypes.RuntimeGrass.tropical_plant_2'
foliage[5]=RuntimeGrass'Archetypes.RuntimeGrass.flower'
foliage[6]=RuntimeGrass'Archetypes.RuntimeGrass.flower'
foliage[7]=RuntimeGrass'Archetypes.RuntimeGrass.parviflora'
foliage[8]=RuntimeGrass'Archetypes.RuntimeGrass.palm_plant'
foliage[9]=RuntimeGrass'Archetypes.RuntimeGrass.tropical_plant_1'
foliage[10]=RuntimeGrass'Archetypes.RuntimeGrass.flower'
}